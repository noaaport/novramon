...
proc ::ssh::connect {args} {
    ...
    set F [open "|ssh $opts $option(t)" r+];
...
proc ::ssh::send-exit {host} {

    ::ssh::push $host "exit";
    ::ssh::send $host;
}

proc ::ssh::pop-line {host line_varname} {
#
# Returns: the same as "get <filehandle> line"
#
...
proc ::ssh::pop-all {host output_varname} {
#
...
#
    ...
    while {[::ssh::pop-line $host line] >= 0} {
	incr r;
...
proc ::ssh::rexec {host script output_varname} {
    ...
    ::ssh::rexec-nopop $host $script;
    ::ssh::pop-all $host output;
}

proc ::ssh::rexec-nopop {host script} {
