// Free implementation of the MD2 hash algorithm
...
void CMD2::Update(const unsigned char *buf, unsigned int len)
{
	unsigned long L = 0;
	unsigned char t = 0;
	int i = 0, j = 0;
...
void CMD2::TruncatedFinal(unsigned char *hash, unsigned int size)
{
	...
	Init(); // Quickly erase the temporary buffers (security reasons)
}
