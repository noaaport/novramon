...
//***************************************************************************
//
// This File defines the Packets used to communicate with the S75 version 5.X PesMaker
// 

#ifndef		__PESMAKERPACKETS__
#define		__PESMAKERPACKETS__
#define		__NUMBER_OF_PIDS__		32

#include "NovraDevicePackets.h"


//typedef struct PesMakerNetConfig_MSG{
//
...
//}PesMakerNetConfig_MSG;

typedef struct PesMakerRFConfig_MSG{
