...
void SJ300::initAttributes()
{
	...
	parameterMask[ NETWORK_CODE_DOWNLOAD			] = F_EXISTS | F_DEF | F_READ | F_FLAG;
	...
	parameterMask[ ISI_ENABLE						] = F_EXISTS | F_CONFIG | F_READ | F_WRITE | F_FLAG | F_ENUM;
	parameterMask[ INPUT_STREAM_IDENTIFIER			] = F_EXISTS | F_CONFIG | F_READ | F_WRITE | F_SHORT;
	parameterMask[ INPUT_STREAM_IDENTIFIER_MASK		] = F_EXISTS | F_CONFIG | F_READ | F_WRITE | F_SHORT;
	parameterMask[ TARGET_MODCOD					] = F_EXISTS | F_CONFIG | F_READ | F_WRITE | F_SHORT | F_ENUM;
